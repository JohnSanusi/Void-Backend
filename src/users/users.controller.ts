...
export class UsersController {
    ...
    async manageRequest(@Req() req: RequestWithUser, @Body() dto: ManageRequestDto) {
        return this.usersService.handleFollowRequest(req.user.userId, dto.requesterId, dto.accept);
    }
